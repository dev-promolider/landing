...
class paypal_class {
	...
	public function submit_paypal_post() {
		...
		echo "<center><h2>Porfavor espera, Tu orden se esta procesando y ";
		echo "seras redirigido a PayPal para confirmar tu pago.</h2></center>\n";
		...
		echo "<center><br/><br/>Si no has sido redirigiado a paypal y ya ";
		echo "transcurrieron 5 segundos...<br/><br/>\n";
