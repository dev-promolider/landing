<?php
check_admin();
$s = mysqli_query($connection,"SELECT * FROM bono_inicio");
$r = mysqli_fetch_array($s);

if(isset($enviar)){
	$bono = clear($bono);
	mysqli_query($connection,"UPDATE bono_inicio SET precio = '$bono'");
	alert("Bono Modificado");
	redir("");
}
?>
<h1><i class="fa fa-edit"></i> Modificar Bono de Inicio</h1><br>
