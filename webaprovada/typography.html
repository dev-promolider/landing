...
<!-- Head -->
<head>
<title>Business Group a Corporate Category Bootstrap responsive Website Template | Short Codes :: w3layouts</title>
							...
							<nav>
								...
								<li class="dropdown active">
									...
									<ul class="dropdown-menu">
										...
										<li class="active"><a href="typography.html">Short Codes</a></li>
									</ul>
							  </li>
